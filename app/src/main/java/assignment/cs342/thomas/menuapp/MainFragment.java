    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == PHOTO_TAKEN_REQUEST) {
                Log.d("MainFragment", "before rendering photo to ImageView");
                if (data != null) {
...
//        String imageFileName = "JPEG_" + timeStamp + "_";
        String imageFileName = "file_image";
        ...
        Log.d("MainFragment", mCurrentPhotoPath);
        return image;
    }
    ...
    private void openCamera() {
        ...
        if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Log.d("MainFragment", "photoFile successfully created");

                Uri photoURI = FileProvider.getUriForFile(getActivity(),
                        "assignment.cs342.thomas.menuapp.fileprovider",
                        photoFile);
                Log.d("MainFragment", photoURI.toString());
